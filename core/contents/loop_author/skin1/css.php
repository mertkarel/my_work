.tally_loop_author .tla_info{ background-color: #F9F9F9; padding: 25px 25px; border-bottom: solid 5px; }
...
.tally_loop_author .tla_post_item .tla_post_more:hover{ text-decoration: none; }